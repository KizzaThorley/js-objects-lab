...
*/
game.party.push(pokemon[112], pokemon[149], pokemon[134])
...
game.party.splice(3, 1, pokemon[8])
...
*/
game.party.forEach((Pnames) => {
    // console.log(Pnames.name);
})
...
pokemon.forEach((isStarter) => {
    if (isStarter.starter === true) {
        console.log(isStarter.name);
    }
})
